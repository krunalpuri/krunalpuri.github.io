...
- Designed scalable microservices using Java, Go, and TypeScript.
- Implemented Netflix OSS and Keycloak authentication.
- Built CI/CD pipelines.
- Migrated monolithic ERP systems to microservices using Java and Ruby on Rails on OpenShift and AWS.
- Designed Ethereum-based dividend token and React Web3 platform.
- Prototyped machine learning systems for NLP, face recognition, and malware detection.
- Built AWS S3 and Elasticsearch WordPress plugin.

Technologies: Flutter, BLoC, Firebase, Java, Go, TypeScript, Netflix OSS, Keycloak, CI/CD, Ruby on Rails, OpenShift, AWS, Ethereum, React Web3, NLP, face recognition, malware detection, Elasticsearch.
...
### NIST — Guest Researcher — May 2016–Aug 2017

Summary: Developed evaluation infrastructure and scalable big data systems for data science competitions.
...
### The George Washington University — Teaching Assistant — 2015–2017

Summary: Led lab sessions and mentored students.
...
Summary: Developed secure cyber threat messaging and GPU-enhanced malware detection systems.

Responsibilities:
- Developed a secure threat messaging platform using STIX and TAXII.
- Enhanced malware detection with GPUs.

Technologies: STIX, TAXII, cybersecurity, malware detection, GPU computing.

### BCM Consulting Group LLC — Software Developer Intern — Jul 2014–May 2015

Summary: Built big data and parallel computing systems on AWS.

Responsibilities:
- Built Hadoop big data platform on AWS.
- Worked on CUDA parallel computing.

Technologies: Hadoop, AWS, CUDA, big data, parallel computing.

### Puri Enterprise — Founder / Software Developer — 2012–2013

Summary: Led a web development startup focused on corporate and e-commerce websites.

Responsibilities:
- Built corporate websites.
- Built e-commerce websites.
- Led client-facing web development projects.

Technologies: web development, e-commerce, corporate websites.
